package com.palmaactiva.intro_programacion.modulo2.excepciones;
...
public class EjercicioExcepciones {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            do {
                lineaTexto = Terminal.leerString();
                if (lineaTexto.trim().equalsIgnoreCase("salir")) {
                    ...
                    try {
                        ...
                        System.out.println("ERROR, el valor no es válido: " + e.getMessage() + "!\n");
                        valorValido = false;
                    }
                }
            } while (!valorValido);
