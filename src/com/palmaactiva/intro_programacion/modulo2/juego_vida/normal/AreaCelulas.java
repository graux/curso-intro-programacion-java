...
import com.palmaactiva.intro_programacion.modulo2.juego_vida.basico.Celula;
...
public class AreaCelulas extends JComponent implements ActionListener {
    private final int numCelulasHorizontales;
    private final int numCelulasVerticales;
