package com.palmaactiva.intro_programacion.modulo3.ejercicio_personas_serializacion;
...
public class AppPersonasSerializacion {
    ...
    private static final String[] APELLIDOS = new String[]{"Garcia", "Fernández", "Martínez", "Torres", "Hernandez",
        ...
        "Coll"};
    private final HashMap<String, Persona> personas;
    private final String departamentoActual = "clientes";

    public AppPersonasSerializacion() {
    ...
    private Persona crearPersona(Scanner teclado) {
        ...
        String dniCompleto = String.valueOf(dni) + EjercicioDNIAvanzado.getLetraDNI(dni);
    ...
    public static void main(String[] args) {
        AppPersonasSerializacion miPrograma = new AppPersonasSerializacion();
