...
public class AppEjercicioDiccionarioSerializacion {
    ...
    public AppEjercicioDiccionarioSerializacion() {
    ...
    public static void main(String[] args) {
        AppEjercicioDiccionarioSerializacion miDicApp = new AppEjercicioDiccionarioSerializacion();
