package com.palmaactiva.intro_programacion.modulo3.ejercicio_paises;
...
public class AppPaises implements Comparator<Pais> {

    private final Pais[] paisesEjercicio;
    private static final DecimalFormat formatoNumero = (DecimalFormat) NumberFormat.getInstance(new Locale("es", "ES"));

    public AppPaises(int numPaises) {
    ...
    private long ordernarArrayList() {
        List<Pais> arrList = new ArrayList<>();
        long tStart = System.nanoTime();
    ...
    public long busquedasArray(AppPaises miApp, int numBusquedas) {
        long tiempos = 0;
    ...
    public long busquedasArrayList(AppPaises miApp, int numBusquedas) {
        long tiempos = 0;
        String codigoPais;
    ...
    public long busquedasLinkedList(AppPaises miApp, int numBusquedas) {
        long tiempos = 0;
        String codigoPais;
        LinkedList<Pais> lnkList = new LinkedList<>();
        lnkList.addAll(Arrays.asList(this.paisesEjercicio));
    ...
    public long busquedasTreeSet(AppPaises miApp, int numBusquedas) {
        long tiempos = 0;
        String codigoPais;
    ...
    public long busquedasTreeMap(AppPaises miApp, int numBusquedas) {
        long tiempos = 0;
        String codigoPais;
    ...
    public long busquedasHashMap(AppPaises miApp, int numBusquedas) {
        long tiempos = 0;
        String codigoPais = null;
    ...
    public static void main(String[] args) {
        AppPaises miApp = new AppPaises(250);
