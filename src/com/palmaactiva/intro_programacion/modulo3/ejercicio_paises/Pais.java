...
public class Pais implements Comparable<Pais> {
    ...
    private static final String[] PREFIJOS = new String[]{"United ", "Central ", "Bis", "Hispa", "Celtic", "Rumi", "Ocran",
    ...
    private static final String[] SUFIJOS = new String[]{"lands", "ibia", "land", "enta", "istan", "opa", "menia", "aman",
        "ean", "ilia", "upia", " Republic", " States", " Kingdom", "tria", "dor", " United", "anda", "vion", "osha",
        "davia", "ia", "ria", "ran", "garia", "chistan", "tan", "anda"};
    private static final HashMap<String, Pais> paisesAleatorios = new HashMap<>();
